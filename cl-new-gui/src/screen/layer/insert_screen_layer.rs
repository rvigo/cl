...
impl Default for InsertScreenLayer {
    fn default() -> Self {
        ...
        let app_name = StaticInfo::new("cl - insert");
...
impl Layer for InsertScreenLayer {
...
mod tests {
    ...
    fn should_get_the_current_field() {
        let layer = InsertScreenLayer::default();
